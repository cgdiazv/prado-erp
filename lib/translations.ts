...
type TranslationBundle = {
  ...
  dashboard: {
    ...
    dispatchPlannerTitle: string;
    dispatchPlannerDescription: string;
    unassignedJobs: string;
    routeRoutes: string;
    routeSavedLocally: string;
    routeDropHint: string;
    routeReorderHint: string;
    routeStops: string;
    routeCustomer: string;
    routeOptimizeAll: string;
    routeOptimizeTruck: string;
    routeAutoAssignMap: string;
    routeCapacityWarning: string;
    routeMissingGeo: string;
