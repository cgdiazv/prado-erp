...
export default function AITaskAssistantModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs select-none">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl transition-all">
        {/* Header */}
        ...
        <div className="mt-4 space-y-3 rounded-xl border border-emerald-100 bg-emerald-50/40 p-4">
          ...
          <div className="flex items-center justify-end gap-3 pt-2 border-t border-emerald-200/50">
            <button
              type="button"
              onClick={onClose}
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-4 py-2 text-xs font-semibold text-white shadow-md hover:bg-slate-800 disabled:opacity-50 transition cursor-pointer"
            >
              {isPending ? (
                <>
                  <Loader2 className="h-3.5 w-3.5 animate-spin" />
