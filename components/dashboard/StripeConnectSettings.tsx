    ...
    <div className="p-6 md:p-8 space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          disabled={pending}
          className="w-full rounded-lg bg-violet-600 px-4 py-2 text-xs font-semibold text-white transition hover:bg-violet-700 disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto"
        >
          {pending
            ? isEs
              ? 'Procesando...'
        ...
        <button
          ...
          disabled={pending}
          className="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-xs font-semibold text-slate-700 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto"
        >
