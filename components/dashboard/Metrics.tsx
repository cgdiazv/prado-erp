  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
        ...
        <span className="text-2xl font-bold text-emerald-600 font-mono">${totalRevenue.toFixed(2)}</span>
      </div>
      <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
      ...
      <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
        ...
        <span className={`text-2xl font-bold font-mono ${netProfit >= 0 ? 'text-blue-600' : 'text-orange-600'}`}>
          ${netProfit.toFixed(2)}
        </span>
      </div>
    </section>
