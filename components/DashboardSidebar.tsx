...
export default function DashboardSidebar() {
  ...
  // Helper utility function to check link styling states cleanly
  ...
  return (
    <aside className="hidden md:flex w-64 border-r border-gray-200 bg-white flex-col sticky top-[57px] h-[calc(100vh-57px)] p-4 select-none shrink-0">
      <div className="space-y-1 flex-1">
        ...
        {/* Terminal Overview Dashboard Link */}
        ...
        <Link href="/dashboard/schedule" className={linkStyle('/dashboard/schedule')}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
        ...
        <Link href="/dashboard/ledger" className={linkStyle('/dashboard/ledger')}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
