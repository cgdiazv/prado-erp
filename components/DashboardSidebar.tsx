    ...
    <>
      ...
      `}>
        <div className="space-y-1 flex-1 overflow-y-auto overflow-x-hidden pt-2 md:pt-0">
          ...
          <Link href="/dashboard/estimates" onClick={closeSidebar} className={linkStyle('/dashboard/estimates')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
          ...
          {showPremiumFeatures && (
            <>
              ...
              <Link href="/dashboard/invoices-ledger" onClick={closeSidebar} className={linkStyle('/dashboard/invoices-ledger')}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
