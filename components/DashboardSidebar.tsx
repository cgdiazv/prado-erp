          ...
          <div className="pt-4 border-t border-gray-100 mt-4">
            ...
            <form action={localizedHref('/auth/signout')} method="POST">
              <button
                type="submit"
                onClick={closeSidebar}
                className="flex w-full cursor-pointer items-center gap-2.5 px-3 py-2 text-sm transition rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-50 font-medium"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
