...
export default function DashboardSidebar({ subscriptionStatus }: DashboardSidebarProps) {
    ...
    <>
      ...
      `}>
        <div className="space-y-1 flex-1 overflow-y-auto overflow-x-hidden pt-2 md:pt-0">
          ...
          <Link href="/dashboard" onClick={closeSidebar} className={linkStyle('/dashboard')}>
          ...
          <Link href="/dashboard/customers" onClick={closeSidebar} className={linkStyle('/dashboard/customers')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
          ...
          <Link href="/dashboard/schedule" onClick={closeSidebar} className={linkStyle('/dashboard/schedule')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
          ...
          {showPremiumFeatures && (
            <>
              ...
              <Link href="/dashboard/ledger" onClick={closeSidebar} className={linkStyle('/dashboard/ledger')}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
          ...
          <div className="pt-4 border-t border-gray-100 mt-4">
            ...
            <Link href="/dashboard/settings" onClick={closeSidebar} className={linkStyle('/dashboard/settings')}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
