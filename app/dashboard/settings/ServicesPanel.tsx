...
export default function ServicesPanel({ initialServices }: ServicesPanelProps) {
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div>
        <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider mb-1">Services</h3>
        <p className="text-xs text-slate-400">Add or remove service types that can be assigned to jobs in the scheduling workflow.</p>
      </div>

      <form onSubmit={handleAddService} className="flex flex-col sm:flex-row gap-2 max-w-2xl">
        <input
          type="text"
          value={draftName}
