...
export default function TrucksPanel({ initialTrucks }: TrucksPanelProps) {
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div>
        <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider mb-1">Trucks</h3>
        <p className="text-xs text-slate-400">Create and retire fleet vehicles that can be assigned to future dispatch workflows.</p>
      </div>

      <form onSubmit={handleAddTruck} className="flex flex-col sm:flex-row gap-2 max-w-2xl">
        <input
          type="text"
          value={draftName}
