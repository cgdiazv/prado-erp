...
import MobileSidebarToggle from '@/components/MobileSidebarToggle'; // Injected component
...
export default async function DashboardHome() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col text-gray-900 selection:bg-emerald-500 selection:text-slate-950 font-sans relative">
      ...
      <div className="flex flex-1 relative">
        ...
        <main className="flex-1 p-6 md:p-12 overflow-y-auto">
          <div className="max-w-5xl ml-0 space-y-8 text-left">
            ...
            <PerformanceChart totalRevenue={totalRevenue} totalExpenses={totalExpenses} netProfit={netProfit} />

          </div>
        </main>
      </div>

      {/* Floating Action Mobile Toggle Trigger */}
      <MobileSidebarToggle />
    </div>
  );
}