            ...
            <header className="bg-white p-6 md:p-8 rounded-xl border border-gray-200 shadow-xs">
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                ...
                <div className="text-xs text-slate-600 space-y-1.5 md:text-right border-t md:border-t-0 pt-4 md:pt-0 border-gray-100 min-w-[200px]">
                  <div><strong className="text-slate-400 uppercase font-bold text-[10px] tracking-wide block md:inline md:mr-1">Email:</strong> {customer.email || '—'}</div>
                  <div><strong className="text-slate-400 uppercase font-bold text-[10px] tracking-wide block md:inline md:mr-1">Phone:</strong> {customer.phone || '—'}</div>
                  <div><strong className="text-slate-400 uppercase font-bold text-[10px] tracking-wide block md:inline md:mr-1">Billing Address:</strong> {customer.billing_address || '—'}</div>
                </div>
              </div>
            </header>
