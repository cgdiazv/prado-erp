...
export default function PricingPage() {
  const handleStripeCheckout = (planType: 'individual' | 'enterprise') => {
    if (planType === 'individual') {
      // First Tier link
      window.location.href = 'https://pay.indevasa.com/b/00wdR85i76E4dXg2Yl4Ni04';
    } else {
      // UPDATED: Second Tier link added here
      window.location.href = 'https://pay.indevasa.com/b/eVq4gy5i73rS5qKdCZ4Ni05';
    }
  };
